...
```
$ docker run --rm -p 8080:8080 customer-relationship-adapter-application:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/customer-relationship-adapter-application
```
